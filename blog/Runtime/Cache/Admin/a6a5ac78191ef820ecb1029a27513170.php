...
<html lang="en">
    ...
    <head>
        ...
        <link href="/mkblog/Public/Admin/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css" rel="stylesheet" type="text/css" />
        <link href="/mkblog/Public/Admin/assets/global/plugins/morris/morris.css" rel="stylesheet" type="text/css" />
        <link href="/mkblog/Public/Admin/assets/global/plugins/fullcalendar/fullcalendar.min.css" rel="stylesheet" type="text/css" />
        <link href="/mkblog/Public/Admin/assets/global/plugins/jqvmap/jqvmap/jqvmap.css" rel="stylesheet" type="text/css" />
        ...
        <link href="/mkblog/Public/Admin/assets/layouts/layout/css/layout.min.css" rel="stylesheet" type="text/css" />
        <link href="/mkblog/Public/Admin/assets/layouts/layout/css/themes/darkblue.min.css" rel="stylesheet" type="text/css" id="style_color" />
        <link href="/mkblog/Public/Admin/assets/layouts/layout/css/custom.min.css" rel="stylesheet" type="text/css" />
	...
	<div class="page-header-inner ">
	    ...
	    <div class="page-logo">
	        <a href="index.html">
	            <img src="/mkblog/Public/Admin/assets/layouts/layout/img/logo.png" alt="logo" class="logo-default" /> </a>
	    ...
	    <div class="top-menu">
	        <ul class="nav navbar-nav pull-right">
	                    ...
	                    <li>
	                        <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
	                            <li>
	                                <a href="#">
	                                    <span class="photo">
	                                        <img src="/mkblog/Public/Admin/assets/layouts/layout3/img/avatar2.jpg" class="img-circle" alt=""> </span>
	                                    <span class="subject">
	                            ...
	                            <li>
	                                <a href="#">
	                                    <span class="photo">
	                                        <img src="/mkblog/Public/Admin/assets/layouts/layout3/img/avatar3.jpg" class="img-circle" alt=""> </span>
	                                    <span class="subject">
	                            ...
	                            <li>
	                                <a href="#">
	                                    <span class="photo">
	                                        <img src="/mkblog/Public/Admin/assets/layouts/layout3/img/avatar1.jpg" class="img-circle" alt=""> </span>
	                                    <span class="subject">
	            ...
	            <li class="dropdown dropdown-user">
	                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
	                    <img alt="" class="img-circle" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar3_small.jpg" />
	                ...
	                <div class="portlet light bordered">
	                    ...
	                    <div class="portlet-body">
	                        <div id="site_statistics_loading">
	                            <img src="/mkblog/Public/Admin/assets/global/img/loading.gif" alt="loading" /> </div>
	                                ...
	                                <div class="mt-comments">
	                                    <div class="mt-comment">
	                                        <div class="mt-comment-img">
	                                            <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar1.jpg" /> </div>
	                                    ...
	                                    <div class="mt-comment">
	                                        <div class="mt-comment-img">
	                                            <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar6.jpg" /> </div>
	                                        <div class="mt-comment-body">
	                                            <div class="mt-comment-info">
	                                    ...
	                                    <div class="mt-comment">
	                                        <div class="mt-comment-img">
	                                            <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar8.jpg" /> </div>
	                                        <div class="mt-comment-body">
	                                            <div class="mt-comment-info">
	                                    ...
	                                    <div class="mt-comment">
	                                        <div class="mt-comment-img">
	                                            <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar4.jpg" /> </div>
	                                        <div class="mt-comment-body">
	                                            <div class="mt-comment-info">
	                        ...
	                        <div class="tab-content">
	                                ...
	                                <div class="mt-actions">
	                                    <div class="mt-action">
	                                        <div class="mt-action-img">
	                                            <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar10.jpg" /> </div>
	                                    ...
	                                    <div class="mt-action">
	                                        <div class="mt-action-img">
	                                            <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar3.jpg" /> </div>
	                                        <div class="mt-action-body">
	                                            <div class="mt-action-row">
	                                                <div class="mt-action-info ">
	                                                    <div class="mt-action-icon ">
	                                    ...
	                                    <div class="mt-action">
	                                        <div class="mt-action-img">
	                                            <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar2.jpg" /> </div>
	                                        <div class="mt-action-body">
	                                            <div class="mt-action-row">
	                                                <div class="mt-action-info ">
	                                                    <div class="mt-action-icon ">
	                                    ...
	                                    <div class="mt-action">
	                                        <div class="mt-action-img">
	                                            <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar7.jpg" /> </div>
	                                        <div class="mt-action-body">
	                                            <div class="mt-action-row">
	                                                <div class="mt-action-info ">
	                                                    <div class="mt-action-icon ">
	                                    ...
	                                    <div class="mt-action">
	                                        <div class="mt-action-img">
	                                            <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar9.jpg" /> </div>
	                                        <div class="mt-action-body">
	                                            <div class="mt-action-row">
	                                                <div class="mt-action-info ">
	                                                    <div class="mt-action-icon ">
	                            ...
	                            <div class="tab-pane" id="tab_actions_completed">
	                                ...
	                                <div class="mt-actions">
	                                    ...
	                                    <div class="mt-action">
	                                        <div class="mt-action-img">
	                                            <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar5.jpg" /> </div>
	                                        <div class="mt-action-body">
	                                            <div class="mt-action-row">
	                                                <div class="mt-action-info ">
	                                                    <div class="mt-action-icon ">
	                            ...
	                            <div class="events-content">
	                                <ol>
	                                    <li class="selected" data-date="16/01/2014">
	                                        ...
	                                        <div class="mt-author">
	                                            <div class="mt-avatar">
	                                                <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar80_3.jpg" />
	                                            </div>
	                                    ...
	                                    <li data-date="20/04/2014">
	                                        ...
	                                        <div class="mt-author">
	                                            <div class="mt-avatar">
	                                                <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar80_1.jpg" />
	                                            </div>
	                                            <div class="mt-author-name">
	                                    ...
	                                    <li data-date="20/05/2014">
	                                        ...
	                                        <div class="mt-author">
	                                            <div class="mt-avatar">
	                                                <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar80_2.jpg" />
	                                            </div>
	                                            <div class="mt-author-name">
	                                                <a href="javascript:;" class="font-blue-madison">Andres Iniesta</a>
	                                            </div>
	                                    ...
	                                    <li data-date="30/08/2014">
	                                        ...
	                                        <div class="clearfix"></div>
	                                        <div class="mt-content border-grey-steel">
	                                            <img class="timeline-body-img pull-left" src="/mkblog/Public/Admin/assets/pages/media/blog/5.jpg" alt="">
	                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis
	                                                qui ut. laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut. </p>
	                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis
	                                                qui ut. laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut. </p>
	                                    ...
	                                    <li data-date="15/09/2014">
	                                        ...
	                                        <div class="mt-author">
	                                            <div class="mt-avatar">
	                                                <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar80_5.jpg" />
	                                            </div>
	                                            <div class="mt-author-name">
	                                        ...
	                                        <div class="clearfix"></div>
	                                        <div class="mt-content border-grey-steel">
	                                            <img class="timeline-body-img pull-right" src="/mkblog/Public/Admin/assets/pages/media/blog/6.jpg" alt="">
	                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis
	                                                qui ut.</p>
	                ...
	                <div class="portlet light bordered">
	                    ...
	                    <div class="portlet-body" id="chats">
	                        <div class="scroller" style="height: 525px;" data-always-visible="1" data-rail-visible1="1">
	                            <ul class="chats">
	                                <li class="out">
	                                    <img class="avatar" alt="" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar2.jpg" />
	                                    <div class="message">
	                                        <span class="arrow"> </span>
	                                ...
	                                <li class="in">
	                                    <img class="avatar" alt="" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar1.jpg" />
	                                    <div class="message">
	                                        <span class="arrow"> </span>
	                                ...
	                                <li class="out">
	                                    <img class="avatar" alt="" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar3.jpg" />
	                                    <div class="message">
	                                        <span class="arrow"> </span>
	                        ...
	                        <div class="row">
	                            <div class="col-md-4">
	                                ...
	                                <div class="mt-widget-1">
	                                    ...
	                                    <div class="mt-img">
	                                        <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar80_8.jpg"> </div>
	                                    <div class="mt-body">
	                            ...
	                            <div class="col-md-4">
	                                ...
	                                <div class="mt-widget-1">
	                                    ...
	                                    <div class="mt-img">
	                                        <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar80_7.jpg"> </div>
	                                    <div class="mt-body">
	                            ...
	                            <div class="col-md-4">
	                                ...
	                                <div class="mt-widget-1">
	                                    ...
	                                    <div class="mt-img">
	                                        <img src="/mkblog/Public/Admin/assets/pages/media/users/avatar80_6.jpg"> </div>
	                                    <div class="mt-body">
	                        ...
	                        <div class="row">
	                            <div class="col-md-6">
	                                <div class="mt-widget-2">
	                                    <div class="mt-head" style="background-image: url(/mkblog/Public/Admin/assets/pages/img/background/32.jpg);">
	                                        <div class="mt-head-label">
	                                            <button type="button" class="btn btn-success">Manhattan</button>
	                                        </div>
	                                        <div class="mt-head-user">
	                                            <div class="mt-head-user-img">
	                                                <img src="/mkblog/Public/Admin/assets/pages/img/avatars/team7.jpg"> </div>
	                            ...
	                            <div class="col-md-6">
	                                <div class="mt-widget-2">
	                                    <div class="mt-head" style="background-image: url(/mkblog/Public/Admin/assets/pages/img/background/43.jpg);">
	                                        <div class="mt-head-label">
	                                            <button type="button" class="btn btn-danger">London</button>
	                                        </div>
	                                        <div class="mt-head-user">
	                                            <div class="mt-head-user-img">
	                                                <img src="/mkblog/Public/Admin/assets/pages/img/avatars/team3.jpg"> </div>
	                                            <div class="mt-head-user-info">
	                    ...
	                    <div class="portlet-body">
	                        <div class="row">
	                            <div class="col-md-4">
	                                <div class="mt-widget-4">
	                                    <div class="mt-img-container">
	                                        <img src="/mkblog/Public/Admin/assets/pages/img/background/34.jpg" /> </div>
	                            ...
	                            <div class="col-md-4">
	                                <div class="mt-widget-4">
	                                    <div class="mt-img-container">
	                                        <img src="/mkblog/Public/Admin/assets/pages/img/background/46.jpg" /> </div>
	                            ...
	                            <div class="col-md-4">
	                                <div class="mt-widget-4">
	                                    <div class="mt-img-container">
	                                        <img src="/mkblog/Public/Admin/assets/pages/img/background/37.jpg" /> </div>
	                ...
	                <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
	                    ...
	                    <ul class="media-list list-items">
	                        <li class="media">
	                            ...
	                            <img class="media-object" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar3.jpg" alt="...">
	                        ...
	                        <li class="media">
	                            <img class="media-object" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar1.jpg" alt="...">
	                            <div class="media-body">
	                        ...
	                        <li class="media">
	                            ...
	                            <img class="media-object" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar4.jpg" alt="...">
	                            <div class="media-body">
	                        ...
	                        <li class="media">
	                            <img class="media-object" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar2.jpg" alt="...">
	                            <div class="media-body">
	                    ...
	                    <ul class="media-list list-items">
	                        <li class="media">
	                            ...
	                            <img class="media-object" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar6.jpg" alt="...">
	                            <div class="media-body">
	                        ...
	                        <li class="media">
	                            ...
	                            <img class="media-object" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar7.jpg" alt="...">
	                            <div class="media-body">
	                        ...
	                        <li class="media">
	                            <img class="media-object" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar8.jpg" alt="...">
	                            <div class="media-body">
	                        ...
	                        <li class="media">
	                            ...
	                            <img class="media-object" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar9.jpg" alt="...">
	                            <div class="media-body">
	                        ...
	                        <li class="media">
	                            <img class="media-object" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar10.jpg" alt="...">
	                            <div class="media-body">
	                        ...
	                        <li class="media">
	                            ...
	                            <img class="media-object" src="/mkblog/Public/Admin/assets/layouts/layout/img/avatar11.jpg" alt="...">
	                            <div class="media-body">
	...
	<div class="page-footer-inner"> 2017 &copy; Metronic by keenthemes.
...
<![endif]-->
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="/mkblog/Public/Admin/assets/global/plugins/moment.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/morris/morris.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/morris/raphael-min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/counterup/jquery.waypoints.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/counterup/jquery.counterup.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/amcharts/amcharts/amcharts.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/amcharts/amcharts/serial.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/amcharts/amcharts/pie.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/amcharts/amcharts/radar.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/amcharts/amcharts/themes/light.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/amcharts/amcharts/themes/patterns.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/amcharts/amcharts/themes/chalk.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/amcharts/ammap/ammap.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/amcharts/ammap/maps/js/worldLow.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/amcharts/amstockcharts/amstock.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/horizontal-timeline/horozontal-timeline.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/flot/jquery.flot.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/flot/jquery.flot.resize.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/flot/jquery.flot.categories.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/jquery-easypiechart/jquery.easypiechart.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/jquery.sparkline.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/jqvmap/jqvmap/jquery.vmap.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/global/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="/mkblog/Public/Admin/assets/global/scripts/app.min.js" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="/mkblog/Public/Admin/assets/pages/scripts/dashboard.js" type="text/javascript"></script>
        <!-- <script src="/mkblog/Public/Admin/assets/pages/scripts/dashboard.min.js" type="text/javascript"></script> -->
        <!-- END PAGE LEVEL SCRIPTS -->
        <!-- BEGIN THEME LAYOUT SCRIPTS -->
        <script src="/mkblog/Public/Admin/assets/layouts/layout/scripts/layout.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/layouts/layout/scripts/demo.min.js" type="text/javascript"></script>
        <script src="/mkblog/Public/Admin/assets/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
